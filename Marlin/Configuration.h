...
#define STRING_CONFIG_H_AUTHOR "(Jorge Pinto, default config)" // Who made the changes.
...
#define EXTRUDER_OFFSET_X {0.0, 64.5} // (in mm) for each extruder, offset of the hotend on the X axis

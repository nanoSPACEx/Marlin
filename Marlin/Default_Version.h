...
#if true
#define SHORT_BUILD_VERSION "V1.1.0-RC2 BEEVC.01"
#define DETAILED_BUILD_VERSION "1.1.0-RC2 BEEVEARYCREATIVE"
#define STRING_DISTRIBUTION_DATE "2015-11-19 16:00"
